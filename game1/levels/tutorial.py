...
def show_instructions(screen, font):
    ...
    instructions_text2 = font.render("Вправо → Влево ← Вверх ↑ Вниз ↓", True, WHITE)
    instructions_text3 = font.render("В левом верхнем углу ваше здоровье", True, WHITE)
    instructions_text4 = font.render("В правом верхнем углу ваши очки", True, WHITE)
    instructions_text5 = font.render("Основной смысл игры заключается в том, чтобы уклоняться от атак и набирать очки", True, WHITE)
    instructions_text6 = font.render("Каждую секунду дается по 10 очков, чтобы перейти на следующий уровень необходимо набрать 1000 очков. Начнем!", True, WHITE)
    ...
    instructions_text_rect6 = instructions_text5.get_rect(center=(WIDTH // 2 - 200, HEIGHT - 700))
    ...
    screen.blit(instructions_text6, instructions_text_rect6)
